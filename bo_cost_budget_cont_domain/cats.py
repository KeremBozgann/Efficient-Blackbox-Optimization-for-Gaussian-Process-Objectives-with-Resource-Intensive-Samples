...
from cats_optimize import cats_optimize
...
def cats_bo(D, objective_func, cost_function, y_true_opt, x_true_opt,
        ...
        if Xt.shape[0]== 0:
            ...
            xt, xt_val, x1_value_list_grid, X1_grid = \
                opt.optimize_cats(num_outer_opt_restarts, domain, num_iter_max, grid_opt_out, D, model, latent_cost_model, f_best,
                  Xt, Yt, kernel, latent_cost_kernel, num_inner_opt_restarts, grid_opt_in, noise, log_Yt_cost, n, noise_cost)
...
def test_fashion():
    ...
    num_layer= 4;  num_init_train_samples=1;

...
y_true_opt, x_true_opt, domain =ackley_opt(D)
X_kern, Y_kern = ackley_plots(disc, D, plot=False)
model, kernel =ackley_find_best_suited_kernel(X_kern, Y_kern, noise=noise)

X_cost_kern, Y_cost_kern =ackley_cost_plots(disc, D, False)
latent_cost_model, latent_cost_kernel =ackley_cost_find_best_suited_kernel(X_cost_kern, Y_cost_kern, noise=noise_cost)
cost_function = ackley_cost

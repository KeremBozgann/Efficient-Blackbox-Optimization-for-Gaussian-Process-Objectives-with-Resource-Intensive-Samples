...
objective_func = synthetic_multi2_2d;
y_true_opt, x_true_opt, domain =synthetic_multi2_2d_opt()
X_kern, Y_kern = synthetic_multi2_2d_plots(disc, plot=False)
model, kernel =synthetic_multi2_2d_find_best_suited_kernel(X_kern, Y_kern, noise=noise)

X_cost_kern, Y_cost_kern = synthetic_multi2_2d_cost_plots(disc, False)
latent_cost_model, latent_cost_kernel =synthetic_multi2_2d_cost_find_best_suited_kernel(X_cost_kern, Y_cost_kern, noise=noise_cost)
cost_function = synthetic_multi2_2d_cost

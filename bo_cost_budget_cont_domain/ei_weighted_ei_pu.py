...
from ei_weighted_ei_pu_opt import eiw_eipu
...
def eiw_eipu_bo(D, objective_func, cost_function, y_true_opt, x_true_opt,
...
def test_multi_opt_1d():
    ...
    random_restarts= 10; num_iter_max= 100
    grid= False
    num_lthc_samples= 1000; num_ei_samples= 100
    budget= 20
...
def test_multi_opt_2d():
    ...
    random_restarts= 10; num_iter_max= 100
    grid= False
    num_lthc_samples= 1000; num_ei_samples= 10
    budget= 15

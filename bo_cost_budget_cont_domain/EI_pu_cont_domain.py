...
def EI_pu_bo_cont_domain(D, objective_func, cost_function, y_true_opt, x_true_opt,
    ...
    while C<budget:
        ...
        if Xt.shape[0] == 0:
            ...
            xt, xt_val = EI_pu_optimize_with_gradient(domain, model, latent_cost_model, random_restarts, num_iter_max, Xt, Yt, Yt_cost, f_best,
    ...
    if plot_color==True and D==2 and objective_func!= 'cifar' and objective_func!= 'fashion'and objective_func!= 'fashion2':
...
def test_multi_opt_2d():
    ...
    loss_list, Xt, Yt, model, cost_list, cum_cost_list, latent_cost_model, f_best_list= \
        EI_pu_bo_cont_domain(D, objective_func, cost_function, y_true_opt, x_true_opt,
                         domain, kernel, budget, x0, latent_cost_kernel, random_restarts, num_iter_max, grid,
                         noise= noise, noise_cost= noise_cost, plot= True, plot_cost=False, num_layer=None,
                         num_dense=None, num_epoch =None, X_init=None, Y_init=None, Y_cost_init=None,
                             hyper_opt_per=False, plot_color= True)
...
def test_fashion2():
    ...
    loss_list, Xt, Yt, model, cost_list, cum_cost_list, latent_cost_model, f_best_list= \
            EI_pu_bo_cont_domain(D, objective_func, cost_function, y_true_opt, x_true_opt,
                             ...
                             noise= noise, noise_cost= noise_cost, plot=False, plot_cost=False, num_layer=None,
                             num_dense=None,
                             num_epoch=1.7, X_init=X, Y_init=Y, Y_cost_init=Y_cost, hyper_opt_per=hyper_opt_per,
                             plot_color=False)

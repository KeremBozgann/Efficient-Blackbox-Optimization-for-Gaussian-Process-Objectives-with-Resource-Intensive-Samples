...
import numpy as np
from plots import plot_evaluation_arrows_1d
...
plot_evaluation_arrows_1d(Xt_ei, Yt_ei, disc, objective_func, cost_function, domain, 'ei')
plot_evaluation_arrows_1d(Xt_ei_pu, Yt_ei_pu, disc, objective_func, cost_function, domain, 'ei_pu')
plot_evaluation_arrows_1d(Xt_carbo, Yt_carbo, disc, objective_func, cost_function, domain, 'carbo')
plot_evaluation_arrows_1d(Xt_imco, Yt_imco, disc, objective_func, cost_function, domain, 'imco')

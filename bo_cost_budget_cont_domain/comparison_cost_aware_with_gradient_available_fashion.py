...
for i in range(total_iterations):
    ...
    if plot_loss_at_each_iteration:
        ...
        loss_and_count_dict = {'ei_pu': [loss_ei_pu, count_ei_pu, cost_grid, f_best_pu],
                               ...
                               'ei_ppu': [loss_ppu, count_ppu, cost_grid, f_best_ppu],
                               'ei': [loss_ei, count_ei, cost_grid, f_best_ei],
                               'ei_prox': [loss_prox, count_prox, cost_grid, f_best_prox]}

        save_to_hf(loss_and_count_dict, hf_name, i)


loss_and_count_dict= {'ei_pu':[loss_ei_pu, count_ei_pu, cost_grid, f_best_pu], 'carbo':[loss_carbo, count_carbo, cost_grid, f_best_carbo],
                      'ei_ppu': [loss_ppu, count_ppu, cost_grid, f_best_ppu], 'ei': [loss_ei, count_ei, cost_grid, f_best_ei],
                      'ei_prox': [loss_prox, count_prox, cost_grid, f_best_prox]}

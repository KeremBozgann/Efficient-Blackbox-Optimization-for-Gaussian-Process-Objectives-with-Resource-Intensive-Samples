...
X_cost_kern, Y_cost_kern = cos_hf_2d_cost_plots(disc, False)
latent_cost_model, latent_cost_kernel =cos_hf_2d_cost_find_best_suited_kernel(X_cost_kern, Y_cost_kern, noise=noise_cost)
cost_function = cos_hf_2d_cost

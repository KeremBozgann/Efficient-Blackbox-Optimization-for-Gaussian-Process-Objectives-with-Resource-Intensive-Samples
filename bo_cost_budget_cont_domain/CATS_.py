...
from CATS_opt import CATS_optimize


def CATS_bo_cont_domain(input_dimension, output_dimension, cost_dimension, objective_func, cost_function, y_true_opt, x_true_opt,
    ...
    while C<budget:
        ...
        if t==0:
            ...
            xt, xt_val, x1_value_list_grid, X1_grid = \
                CATS_optimize(f_best, Xt, Yt, log_Yt_cost, model, latent_cost_model, domain, noise, kernel,
                              cost_kernel,  num_inner_opt_restarts, num_outer_opt_restarts, D,
                              num_iter_max, grid_opt_in, grid_opt_out)
...
def test_CATS(input_dimension, output_dimension, cost_dimension, objective_func, cost_function, y_true_opt,
    ...
    loss_list, Xt, Yt, model, cost_list, cum_cost_list= CATS_bo_cont_domain(input_dimension, output_dimension, cost_dimension,
            objective_func, cost_function, y_true_opt, x_true_opt, domain, kernel, budget, x0, latent_cost_kernel,num_outer_opt_restarts, num_inner_opt_restarts,
                    grid_opt_in, grid_opt_out, noise=noise_cost, noise_cost=noise, num_iter_max=100, plot=False, plot_cost= False)
...
#
# num_outer_opt_restarts= 10; num_inner_opt_restarts= 0
# grid_opt_in= True; grid_opt_out= False
#
# loss_list, Xt, Yt, model, coss_list, cum_cost_list =  test_CATS(input_dimension, output_dimension, cost_dimension, objective_func,

...
from ei_proximity_search_opt import ei_proximity_search_opt

def ei_proximity_search_bo(D, objective_func, cost_function, y_true_opt, x_true_opt,
                 domain, kernel, budget, x0, latent_cost_kernel, random_restarts, num_iter_max, grid,
                         ...
                         X_init= None, Y_init= None, Y_cost_init= None, hyper_opt_per= False):
    ...
    while C<budget:
        ...
        if Xt.shape[0] == 0:
            ...
            xt, xt_val =  ei_proximity_search_opt(kernel, Xt, noise, model, domain, random_restarts, f_best,grid, D, num_iter_max, Yt,
...
def test_synthetic():
    ...
    loss_list, Xt, Yt, model, cost_list, cum_cost_list, latent_cost_kernel= \
...
def test_cifar():
    ...
    loss_list, Xt, Yt, model, cost_list, cum_cost_list, latent_cost_kernel= \
                    ei_proximity_search_bo(D, objective_func, cost_function, y_true_opt, x_true_opt,
                           ...
                           num_dense= num_dense,  X_init=None, Y_init=None, Y_cost_init=None, hyper_opt_per=hyper_opt_per)
...
def test_fashion():
    ...
    loss_list, Xt, Yt, model, cost_list, cum_cost_list, latent_cost_kernel= \
                    ei_proximity_search_bo(D, objective_func, cost_function, y_true_opt, x_true_opt,
                           domain, kernel, budget, x0, latent_cost_kernel, random_restarts, num_iter_max, grid,
                           noise= noise, noise_cost= noise_cost, plot=False, plot_cost=False, num_layer= num_layer,
                           num_dense=None,  X_init=X, Y_init=Y , Y_cost_init= Y_cost, hyper_opt_per= hyper_opt_per)

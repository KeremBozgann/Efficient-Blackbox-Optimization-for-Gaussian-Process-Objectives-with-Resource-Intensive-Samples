...
def ei_pucla_bo(input_dimension, output_dimension, cost_dimension, objective_func, cost_function, y_true_opt, x_true_opt,
    ...
    while C<budget:
        ...
        if t==0:
            ...
            if grid_opt_out==True:
                ...
                Acq_dict= {'ei_pucla': Acq, 'ei_pu':Acq_ei_pu}
...
def test_ei_pucla(input_dimension, output_dimension, cost_dimension, objective_func, cost_function, y_true_opt,
    ...
    loss_list, Xt, Yt, model, cost_list, cum_cost_list= ei_pucla_bo(input_dimension, output_dimension, cost_dimension,
...
#
# num_outer_opt_restarts= 10; num_inner_opt_restarts= 10
# grid_opt_in= True; grid_opt_out= True
#
# loss_list, Xt, Yt, model, cost_list, cum_cost_list = test_ei_pucla(input_dimension, output_dimension, cost_dimension, objective_func,

...
def ucb_target_lcb_cost_bo(X, Y, Y_cost, kernel, cost_kernel, budget, index0,  kapa_targ, kapa_cost, noise=10**(-4), noise_cost= 10**(-4), plot=False, plot_cost= False):
    ...
    while C<budget:
        ...
        if Xt.shape[0]==0:
            ...
            Acq_EI= EI(sigma_X, u_X , f_best); Acq_EI_pu= EI_per_cost(sigma_X, u_X , f_best, u_cost)

            Acq_EI_pu= EI_per_cost(sigma_X, u_X , f_best, u_cost)

            Acq_carbo= EI_cool(sigma_X, u_X , f_best, u_cost, C, budget, budget_init)

            Acq= ucb_target_lcb_cost(u_X, sigma_X, u_latent_cost,sigma_latent_cost, kapa_targ, kapa_cost, f_best)

            Acq_dict= {'utlc':Acq, 'carbo':Acq_carbo, 'EI_pu': Acq_EI_pu, 'EI': Acq_EI}
...
def test_ucb_target_lcb_cost(dimension, ls, var, ls_cost, var_cost,
...
#     test_ucb_target_lcb_cost(dimension, ls, var, ls_cost, var_cost,
#                                      rang, disc, kernel_type, cost_kernel_type, budget, index0, kapa_cost)
...
def EI_cool_bo(X, Y, Y_cost, kernel, cost_kernel, budget, index0, noise=10**(-4), noise_cost= 10**(-4), plot=False, plot_cost= False):
    ...
    while C<budget:
        ...
        if Xt.shape[0]==0:
            ...
            Acq = EI_cool(sigma_X, u_X, f_best, u_cost, C, budget, budget_init)

            Acq_dict= {'EI_cool': Acq, 'EI_pu':Acq_EI_pu, 'EI':Acq_EI}
...
#
# def test_carbo(dimension, ls, var, ls_cost, var_cost,
...
#
#     loss_list, Xt, Yt, model, cost_list, cum_cost_list= EI_cool_bo(X, Y, Y_cost, kernel, cost_kernel,
#                                budget, index0, noise=10**(-4), noise_cost= 10**(-4), plot=True, plot_cost= True)
#
#
#     return loss_list, Xt, Yt, model, cost_list, cum_cost_list
#
...
#     test_carbo(dimension, ls, var, ls_cost, var_cost,

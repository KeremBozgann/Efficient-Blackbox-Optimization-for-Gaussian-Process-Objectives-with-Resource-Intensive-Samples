...
def scipy_minimize_multi_opt_2d_cost():
...
def multi_opt_2d_cost_plots(disc, plot= False):
...
def multi_opt_2d_cost_find_best_suited_kernel(X, Y, noise=10**(-4)):

...
def scipy_minimize_griewank_2d_cost():
...
def griewank_2d_cost_plots(disc, plot= False):
...
def griewank_2d_cost_find_best_suited_kernel(X, Y, noise=10**(-4)):
